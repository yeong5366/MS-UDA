...
class KP_dataset_fake(data.Dataset):
    ...
    def __init__(self, data_dir, split='day', label_folder='pseudo_KP', transform=None, fake_folder=None):
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            for func in self.transform:
                rgb_image, th_image, label = func(rgb_image, th_image, label)
        ...
        return rgb_image, th_image, label, name
